...
class SimpleActionClient(Node):
    def __init__(self):
        ...
        #making sure that the action server exists
        self.action_client.wait_for_server()

        self.goal = Fibonacci.Goal()
        self.goal.order = 10

        #the future will have the result of the action
        self.future = self.action_client.send_goal_async(self.goal,feedback_callback = self.feedbackCallnack)
    ...
    def feedbackCallnack(self, feedback_msg):
